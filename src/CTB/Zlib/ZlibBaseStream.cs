  ...
  internal class ZlibBaseStream : Stream
  {
    ...
    private void finish()
    {
      ...
      else
      {
        ...
        {
          Array.Copy((Array) this._z.InputBuffer, this._z.NextIn, (Array) buffer, 0, this._z.AvailableBytesIn);
          int count = 8 - this._z.AvailableBytesIn;
          int num = this._stream.Read(buffer, this._z.AvailableBytesIn, count);
          if (count != num)
          ...
          Array.Copy((Array) this._z.InputBuffer, this._z.NextIn, (Array) buffer, 0, buffer.Length);
    ...
    private int _ReadAndValidateGzipHeader()
    {
      ...
      switch (num2)
      {
        ...
        case 10:
          ...
          int int32 = BitConverter.ToInt32(buffer1, 4);
          this._GzipMtime = GZipStream._unixEpoch.AddSeconds((double) int32);
          int num3 = num1 + num2;
          if (((int) buffer1[3] & 4) == 4)
          {
            int num4 = this._stream.Read(buffer1, 0, 2);
            int num5 = num3 + num4;
            short num6 = (short) ((int) buffer1[0] + (int) buffer1[1] * 256);
            byte[] buffer2 = new byte[(int) num6];
    ...
    public override int Read(byte[] buffer, int offset, int count)
    {
      ...
      {
        if (num1 != 0 || this._z.AvailableBytesIn != 0)
          ;
